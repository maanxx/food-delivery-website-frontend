...
function Contact() {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      lines: [
        ...
        "info@fooddelivery.vn",
        "marketing@fooddelivery.vn",
      ],
      color: "#2196F3",
    },
    {
  ...
  const faqs = [
    {
      ...
      answer:
        "Bạn có thể đặt món thông qua website hoặc ứng dụng di động của chúng tôi. Chọn món ăn yêu thích, thêm vào giỏ hàng và thanh toán.",
    },
    {
      question: "Thời gian giao hàng là bao lâu?",
      answer:
        "Thời gian giao hàng trung bình là 20-45 phút tùy thuộc vào khoảng cách và số lượng đơn hàng tại thời điểm đặt.",
    },
    {
      question: "Có những phương thức thanh toán nào?",
      answer:
        "Chúng tôi hỗ trợ thanh toán tiền mặt khi nhận hàng, chuyển khoản ngân hàng, thẻ tín dụng và ví điện tử.",
    },
    {
      question: "Có phí giao hàng không?",
      answer:
        "Phí giao hàng từ 15,000đ - 25,000đ tùy theo khoảng cách. Miễn phí giao hàng cho đơn từ 200,000đ.",
    },
    {
      question: "Làm sao để hủy đơn hàng?",
      answer:
        "Bạn có thể hủy đơn hàng trong vòng 5 phút sau khi đặt. Sau thời gian này, vui lòng liên hệ hotline để được hỗ trợ.",
    },
  ];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success(
        "Gửi tin nhắn thành công! Chúng tôi sẽ phản hồi trong vòng 24h.",
      );
      setFormData({
        name: "",
        email: "",
          ...
          <Card className={cx("cta-card")}>
            <CardContent className={cx("cta-content")}>
              ...
              <Typography variant="body1" className={cx("cta-description")}>
                Liên hệ ngay hotline 24/7 của chúng tôi để được hỗ trợ nhanh
                chóng
              </Typography>
