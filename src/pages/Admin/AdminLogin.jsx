...
function AdminLogin() {
    ...
    useEffect(() => {
        if (adminAuth.isAuthenticated && adminAuth.user?.role?.toLowerCase() === "admin") {
            navigate("/admin");
        }
        ...
        <div className={styles.adminLoginContainer}>
            ...
            <div className={styles.leftPanel}>
                <div className={styles.brandHeader}>
                    ...
                    <span className={styles.brandName}>Eatsy <span>Admin</span></span>
                </div>

                <div className={styles.illustrationContent}>
                    <h2>Bảng điều hành quản trị Eatsy</h2>
                    <p>
                        Hệ thống trung tâm quản lý đơn hàng, điều phối tài xế, quản trị danh mục món ăn và phân tích hiệu quả kinh doanh của Eatsy trong thời gian thực.
                    </p>

                    <div className={styles.featureList}>
                        <div className={styles.featureItem}>
                            <span className={styles.featureIcon}>⚡</span>
                            <span className={styles.featureText}>Quản lý đơn hàng Realtime siêu tốc</span>
                        </div>
                        <div className={styles.featureItem}>
                            <span className={styles.featureIcon}>📊</span>
                            <span className={styles.featureText}>Hệ thống báo cáo doanh thu trực quan</span>
                        </div>
                        <div className={styles.featureItem}>
                            <span className={styles.featureIcon}>🔒</span>
                            <span className={styles.featureText}>Bảo mật tối đa, phân quyền an toàn</span>
                        </div>
                    </div>
                </div>
