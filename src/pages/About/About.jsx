      ...
      <div className={cx("hero-section")}>
        <Container maxWidth="lg">
          <div className={cx("hero-content")}>
            <h1>Về Chúng Tôi</h1>
            <p>
              Chúng tôi là đội ngũ đam mê công nghệ và ẩm thực, mang đến cho bạn
              trải nghiệm giao đồ ăn tuyệt vời nhất
            </p>
          </div>
        </Container>
      </div>
          ...
          <Grid container spacing={4} alignItems="center">
            <Grid item xs={12} md={6}>
              <div className={cx("story-content")}>
                <p>
                  Bắt đầu từ năm 2020 với một ý tưởng đơn giản: làm sao để mọi
                  người có thể thưởng thức những món ăn ngon một cách dễ dàng và
                  nhanh chóng nhất.
                </p>
                <p>
                  Chúng tôi đã xây dựng một nền tảng công nghệ hiện đại, kết nối
                  khách hàng với hàng trăm nhà hàng uy tín. Từ những ngày đầu
                  khó khăn với chỉ 5 nhà hàng đối tác, đến nay chúng tôi đã phục
                  vụ hơn 50,000 khách hàng trên khắp cả nước.
                </p>
                <p>
                  Không chỉ dừng lại ở việc giao đồ ăn, chúng tôi luôn nỗ lực
                  mang đến trải nghiệm mua sắm trọn vẹn, từ giao diện thân
                  thiện, đến dịch vụ khách hàng tận tâm.
                </p>
              </div>
            </Grid>
            <Grid item xs={12} md={6}>
              ...
              <Grid item xs={12} md={4} key={index}>
                <Card className={cx("value-card")}>
                  <CardContent className={cx("value-content")}>
                    ...
                    <Typography
                      variant="body1"
                      className={cx("value-description")}
                    >
                      {value.description}
                    </Typography>
                  </CardContent>
              ...
              <Grid item xs={12} sm={6} md={4} key={index}>
                <Card className={cx("team-card")}>
                  <CardContent className={cx("team-content")}>
                    ...
                    <Typography
                      variant="subtitle1"
                      className={cx("team-position")}
                    >
                      {member.position}
                    </Typography>
                    <Typography
                      variant="body2"
                      className={cx("team-description")}
                    >
                      {member.description}
                    </Typography>
                  </CardContent>
            ...
            <CardContent>
              <div className={cx("contact-content")}>
                ...
                <Typography variant="body1" className={cx("contact-subtitle")}>
                  Hãy kết nối với chúng tôi để cùng tạo nên những trải nghiệm ẩm
                  thực tuyệt vời
                </Typography>
