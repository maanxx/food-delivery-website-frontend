    ...
    <div className={cx("home")}>
      ...
      >
        <Container maxWidth="lg">
          ...
          <h6>
            Trải nghiệm đặt món dễ dàng, nhanh chóng và tiện lợi – chỉ vài cú
            nhấp chuột!
          </h6>
          <Link to={"/menu"} className={cx("order-btn")}>
            Đặt Ngay
          </Link>
        </Container>
      </div>
          ...
          <div className={cx("info")}>
            <div className={cx("box")}>
              <div className={cx("icon", { flyin_y_1: isAppear })}>
                <img src={require("@images/home_icon/order.png")} alt="" />
              </div>
              <h1 className={cx({ flyin_x_1: isAppear })}>Đặt Món Dễ Dàng</h1>
              <h5
                style={{ maxWidth: 300 }}
                className={cx({ flyin_x_1: isAppear })}
              >
                Đặt món chỉ với vài bước đơn giản qua nền tảng thân thiện của
                chúng tôi.
              </h5>
            </div>
            ...
            <div className={cx("box")}>
              <div className={cx("icon", { flyin_y_2: isAppear })}>
                <img src={require("@images/home_icon/delivery.png")} alt="" />
              </div>
              <h1 className={cx({ flyin_x_2: isAppear })}>
                Giao Hàng Nhanh Chóng
              </h1>
              <h5
                style={{ maxWidth: 300 }}
                className={cx({ flyin_x_2: isAppear })}
              >
            ...
            <div className={cx("box")}>
              ...
              <h1 className={cx({ flyin_x_3: isAppear })}>
                Chất Lượng Hàng Đầu
              </h1>
              <h5
                style={{ maxWidth: 300 }}
                className={cx({ flyin_x_3: isAppear })}
              >
